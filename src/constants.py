...
MORATORIUMS = [
    ...
    {"locality": "Louisville", "state": "KY", "level": "Local",
     "status": "Enacted", "when": "Aug 13, 2026",
     "note": "6-month moratorium passed by Metro Council. Advanced by P&Z "
             "Committee 7-1 on Aug 4. Originally proposed Sep 2025 after a "
             "1.6M sq ft hyperscale was approved with little public input",
     "lat": 38.25, "lon": -85.76, "expires": "2027-02-13", "as_of": "2026-08-13",
    ...
    {"locality": "York County", "state": "SC", "level": "Local",
     ...
     "source": "https://www.foxcarolina.com/2026/06/22/spartanburg-county-votes-pause-data-center-applications-one-year/"},
    # ── Promoted from story archive, 2026-08-13 ──────────────────────────
    # Verified 2026-08-23: every row below was read against a named outlet or
    # the government's own page. Three of the original promotions did not
    # survive — Mount Vernon was the Washington city, not an Ohio one; Franklin
    # County, VA had no moratorium (residents were still asking for one after
    # the local project was withdrawn); Garrett County, MD turned up nothing at
    # all. The first was corrected, the other two removed.
    {"locality": "Santa Fe County", "state": "NM", "level": "Local",
     "status": "Enacted", "when": "Jul 2, 2026",
     "note": "18-month moratorium, unanimous. Threshold lowered from 100 MW to "
             "1 MW and cumulative-impact monitoring added in response to public "
             "comment; staff to draft water, energy and noise rules",
     "lat": 35.51, "lon": -106.01, "expires": "2028-01-02", "as_of": "2026-08-23",
     "source": "https://www.santafecountynm.gov/news/detail/santa-fe-county-approves-18-month-moratorium-on-data-centers"},
    {"locality": "East Fishkill", "state": "NY", "level": "Local",
     "status": "Enacted", "when": "Jun 25, 2026",
     "note": "3-year moratorium, unanimous, running to Jul 1, 2029. Halts "
             "Treetop Companies' proposed 1.16M sq ft campus south of Old "
             "State Road",
     "lat": 41.53, "lon": -73.79, "expires": "2029-07-01", "as_of": "2026-08-23",
     "source": "https://spectrumlocalnews.com/nys/hudson-valley/news/2026/06/27/east-fishkill-data-center-moratorium"},
    {"locality": "Davie County", "state": "NC", "level": "Local",
     "status": "Enacted", "when": "Jul 7, 2026",
     "note": "1-year moratorium, unanimous, after a two-hour public comment "
             "period on water use and health concerns",
     "lat": 35.93, "lon": -80.55, "expires": "2027-07-07", "as_of": "2026-08-23",
     "source": "https://www.wfdd.org/politics-government/2026-07-07/davie-county-passes-one-year-data-center-moratorium"},
    {"locality": "Nicholasville", "state": "KY", "level": "Local",
     "status": "Enacted", "when": "Aug 2026",
     "note": "6-month moratorium while the commission drafts sound limits and "
             "water/electrical capacity filing rules. No data center "
             "application has been filed; coverage does not record the vote "
             "date, so the end date is not derivable",
     "lat": 37.88, "lon": -84.57, "expires": None, "as_of": "2026-08-23",
     "source": "https://www.wkyt.com/2026/08/11/nicholasville-passes-six-month-moratorium-data-centers/",
     "term": "fixed_undated"},
    {"locality": "Plain City", "state": "OH", "level": "Local",
     "status": "Proposed", "when": "Aug 10, 2026",
     "note": "Council shelved its draft zoning rules — the village attorney "
             "warned the Big Darby Creek setback might not survive a "
             "challenge — and scheduled an Aug 10 vote on a 6-month "
             "moratorium. No outlet has reported the outcome; do not cite "
             "this as enacted",
     "lat": 40.11, "lon": -83.27, "expires": None, "as_of": "2026-08-23",
     "source": "https://abc6onyourside.com/news/local/plain-city-council-to-vote-aug-10-on-six-month-moratorium-on-data-centers"},
    {"locality": "Jefferson County", "state": "IA", "level": "Local",
     "status": "Enacted", "when": "Aug 11, 2026",
     "note": "12-month moratorium adopted unanimously alongside a new data "
             "center ordinance; second and third readings waived so it took "
             "effect at once. County attorney recommended 1 year over the "
             "24 months residents asked for, as more likely to survive a "
             "legal challenge",
     "lat": 41.03, "lon": -91.95, "expires": "2027-08-11", "as_of": "2026-08-23",
     "source": "https://kilj.com/jefferson-county-approves-data-center-ordinance-and-one-year-moratorium/"},
    {"locality": "Bellevue", "state": "WI", "level": "Local",
     "status": "Enacted", "when": "Aug 12, 2026",
     "note": "12-month ban on data center development, 5-0. Board may extend "
             "it a further six months",
     "lat": 44.44, "lon": -87.92, "expires": "2027-08-12", "as_of": "2026-08-23",
     "source": "https://fox11online.com/news/local/bellevue-board-approves-year-long-ban-on-data-center-development-flietner-moratorium-trustees-vote-residents-crowley-tiffany-wrightstown-jet-power-grid-water"},
    {"locality": "Chippewa County", "state": "WI", "level": "Local",
     "status": "Enacted", "when": "Aug 11, 2026",
     "note": "12-month moratorium, 19-0, first and second readings the same "
             "night (extended from the 10 months committee proposed). Applies "
             "only to the six towns under county zoning — Anson, Eagle Point, "
             "Hallie, Lafayette, Wheaton, Woodmohr. Coverage puts the "
             "effective date in September without naming it, so the end date "
             "is not derivable",
     "lat": 45.07, "lon": -91.28, "expires": None, "as_of": "2026-08-23",
     "source": "http://www.leadertelegram.com/news/daily-updates/chippewa-county-board-approves-data-center-moratorium/article_91eb4e5d-9858-41ec-b515-d5d3fc97b747.html",
     "term": "fixed_undated"},
    {"locality": "Shawnee County", "state": "KS", "level": "Local",
     "status": "Enacted", "when": "Aug 13, 2026",
     "note": "2-1: no final action on data center land use applications until "
             "Feb 17, 2027. Applications may still be filed — Compass "
    ...
    {"locality": "Mount Vernon", "state": "WA", "level": "Local",
     "status": "Enacted", "when": "Aug 12, 2026",
     "note": "6-month moratorium, 4-1, with no data center yet proposed. "
             "Planning staff to draft rules on electricity and water demand, "
             "stormwater and building in the Skagit River floodplain",
     "lat": 48.42, "lon": -122.33, "expires": "2027-02-12", "as_of": "2026-08-23",
     "source": "https://www.cascadiadaily.com/2026/aug/13/mount-vernon-temporarily-bans-data-centers/"},
    {"locality": "Hillsboro", "state": "OR", "level": "Local",
     "status": "Enacted", "when": "Jul 27, 2026",
     "note": "120-day land use moratorium on new or expanded data centers and "
             "battery storage as a primary use — Oregon's first. Called with "
             "one day's notice so applications could not be filed ahead of "
             "the vote; applications already in continue",
     "lat": 45.52, "lon": -122.99, "expires": "2026-11-24", "as_of": "2026-08-23",
     "source": "https://www.opb.org/article/2026/07/27/hillsboro-approves-data-center-moratorium/"},
    {"locality": "Red Bank", "state": "NJ", "level": "Local",
     "status": "Enacted", "when": "Jun 11, 2026",
     "note": "Zoning ordinance banning data centers borough-wide, unanimous. "
             "Council also passed a resolution asking the state to pause new "
             "large-scale data centers — the first NJ town to do so",
     "lat": 40.35, "lon": -74.06, "expires": None, "as_of": "2026-08-23",
     "source": "https://www.redbankgreen.com/2026/06/ank-council-oks-adus-small-hotels-bans-data-centers06132026/",
     "term": "standing"},
    # Reported nationally as a ban; the city's own notice says resolution.
    {"locality": "Asbury Park", "state": "NJ", "level": "Local",
     "status": "Enacted", "when": "Jun 10, 2026",
     "note": "Resolution 2026-264, unanimous: urges the governor and "
             "legislature to enact a statewide moratorium, and pauses local "
             "data center applications, zoning changes and site plans while "
             "the city rewrites its zoning code. A council resolution, not a "
             "zoning ban",
     "lat": 40.22, "lon": -74.01, "expires": None, "as_of": "2026-08-23",
     "source": "https://www.cityofasburypark.com/CivicAlerts.aspx?AID=2658",
     "term": "until_event"},
    ...
    {"locality": "Eastport", "state": "ME", "level": "Local",
     ...
     "note": "180-day moratorium, unanimous, on permits for industrial data "
             "centers on land or underwater — aimed at DeepGreen's tidal-"
             "powered proposal off Kendell Head. Buys time to work through "
             "two citizen-initiated zoning ordinances",
     "lat": 44.91, "lon": -66.99, "expires": "2027-02-08", "as_of": "2026-08-23",
     "source": "https://www.mainepublic.org/climate/2026-08-14/eastport-enacts-pause-on-data-center-development"},
    ...
    {"locality": "Fayetteville", "state": "GA", "level": "Local",
     "status": "Enacted", "when": "Mar 5, 2026",
     "note": "Ordinance 26-O-12 prohibits new data centers in every zoning "
             "district, via chapters 200 and 400 of the Unified Development "
             "Ordinance. Follows the fight over the 615-acre QTS campus",
     "lat": 33.45, "lon": -84.46, "expires": None, "as_of": "2026-08-23",
     "source": "https://www.fayetteville-ga.gov/746/Data-Center-Discussion",
     "term": "standing"},
    # Not a citywide prohibition — a geographic one. Corrected 2026-08-23.
    {"locality": "Atlanta", "state": "GA", "level": "Local",
     "status": "Enacted", "when": "Sep 3, 2024",
     "note": "Zoning ban on data centers along the BeltLine and within a "
             "half-mile of MARTA stations, later extended to neighborhood "
             "commercial districts with special use permits required "
             "elsewhere. A geographic ban, not a citywide one",
     "lat": 33.75, "lon": -84.39, "expires": None, "as_of": "2026-08-23",
     "source": "https://www.gpb.org/news/2024/09/04/atlanta-city-council-bans-data-centers-along-beltline",
     "term": "standing"},
    {"locality": "New Jersey (Fair Share Act)", "state": "NJ", "level": "State",
     "status": "Enacted", "when": "Jul 7, 2026",
     "note": "Data Center Fair Share Act (S731/A796) signed by Gov. Sherrill: "
             "creates a separate ratepayer class and rate structure so data "
             "centers cover their own energy use and grid-connection costs, "
             "and curtail before residential customers when the grid is "
             "strained. Not a moratorium",
     "lat": 40.22, "lon": -74.76, "expires": None, "as_of": "2026-08-23",
     "source": "https://www.nj.gov/governor/news/2026/20260707a.shtml",
     "term": "standing"},
    # Was filed as "tax/zoning restrictions". The budget kept the tax break
    # and added a power tax; no statewide zoning requirement was enacted.
    {"locality": "Virginia (data center power tax)", "state": "VA", "level": "State",
     "status": "Enacted", "when": "Jun 30, 2026",
     "note": "2026-28 budget keeps the data center sales-and-use tax "
             "exemption but adds the first statewide electricity consumption "
             "tax on data centers — $0.011/kWh from Jul 1, capped at $600M a "
             "year with the excess refunded. Not a moratorium, and not a "
             "zoning restriction",
     "lat": 37.43, "lon": -78.66, "expires": None, "as_of": "2026-08-23",
    ...
    {"locality": "Oklahoma (SB 1488)", "state": "OK", "level": "State",
     ...
     "note": "SB 1488 (Sen. Sacchieri) would have barred new data centers of "
             "100 MW or more until Nov 1, 2029 and ordered a Corporation "
             "Commission study. Introduced Feb 2, sent to committee Feb 3, "
             "never got a committee or floor vote, died at sine die "
             "adjournment on May 14, 2026",
     "lat": 35.47, "lon": -97.52, "expires": None, "as_of": "2026-08-23",
     "source": "https://legiscan.com/OK/bill/SB1488/2026",
     "term": "standing"},
    # --- Aug 2026 news sweep -------------------------------------------------
    ...
    # ── Tier-A queue promotions, verified 2026-08-23 ──────────────────────
    # Where a source dated a vote only by weekday, `when` is the single
    # weekday consistent with the publication date and the note says so.
    {"locality": "Carter County", "state": "TN", "level": "Local",
     "status": "Enacted", "when": "Aug 17, 2026",
     "note": "1-year moratorium on all AI data centers and cryptocurrency "
             "mining centers, passed 20-1 after public comment ran heavily in "
             "favour, to let the county study environmental and community "
             "impact. The report dates the vote to 'Monday evening' of the "
             "week it published; Aug 17 is that Monday",
     "lat": 36.35, "lon": -82.21, "expires": "2027-08-17", "as_of": "2026-08-23",
     "source": "https://elizabethton.com/2026/08/18/one-year-moratorium-passes-for-ai-data-centers-in-carter-county/"},
    {"locality": "Yadkin County", "state": "NC", "level": "Local",
     "status": "Enacted", "when": "Aug 17, 2026",
     "note": "2-year moratorium, 5-0 after a public hearing — commissioners "
             "doubled the 12 months on the agenda following an hour of "
             "opposition testimony. Covers unincorporated areas ONLY: the "
             "county manager confirmed at the hearing it does not reach "
             "incorporated towns, so WhiteFiber's Yadkinville campus on the "
             "former Unifi properties is outside it. The report dates the vote "
             "to 'Monday' of the week it published; Aug 17 is that Monday",
     "lat": 36.14, "lon": -80.66, "expires": "2028-08-17", "as_of": "2026-08-23",
     "source": "https://www.yadkinripple.com/news/moratorium-approved-for-yadkin-county-as-potential-yadkinville-data-center-project-announced/article_485d48fb-c61b-4167-b885-3d469e9a6bbe.html"},
    {"locality": "East Lansing", "state": "MI", "level": "Local",
     "status": "Enacted", "when": "Aug 11, 2026",
     "note": "6-month extension, unanimous, running to Mar 17, 2027. Extends "
             "the moratorium adopted Mar 2026, which would have lapsed Sep "
             "2026. Preemptive — no data center has been proposed in the city; "
             "the city's zoning ordinance does not address data centers at all "
             "and staff expect to bring draft language in Sep/Oct 2026",
     "lat": 42.74, "lon": -84.48, "expires": "2027-03-17", "as_of": "2026-08-23",
     "source": "https://www.wilx.com/2026/08/12/east-lansing-city-council-votes-extend-data-center-moratorium/"},
    {"locality": "Woodford County", "state": "IL", "level": "Local",
     "status": "Enacted", "when": "Aug 2026",
     "note": "6-month moratorium on data center applications, extendable once "
             "by another 6 months, while the county holds public hearings and "
             "drafts an ordinance. Reported as running through Feb 2027; no "
             "outlet gave the board's vote date, tally, or the exact end day, "
             "so no end date is recorded here",
     "lat": 40.72, "lon": -89.27, "expires": None, "as_of": "2026-08-23",
     "source": "https://wmbdradio.com/2026/08/21/tazewell-county-revisits-data-center-ordinance-woodford-county-passes-moratorium/",
     "term": "fixed_undated"},
    {"locality": "Memphis", "state": "TN", "level": "Local",
     "status": "Proposed", "when": "Aug 18, 2026",
     "note": "12-month pause on data center rezonings, site plan approvals and "
             "building permits, advanced out of committee and passed first "
             "reading on a voice vote; further readings are required before it "
             "takes effect. Sponsored by council chair Jana Swearengen-"
             "Washington with J.B. Smiley Jr. and Yolanda Cooper-Sutton. Would "
             "NOT reach xAI's existing Colossus facilities — only new "
             "approvals. Some residents are pressing for 18-24 months",
     "lat": 35.15, "lon": -90.05, "expires": None, "as_of": "2026-08-23",
     "source": "https://www.actionnews5.com/2026/08/18/memphis-city-council-committee-advances-data-center-moratorium-proposal/"},
    {"locality": "Lubbock", "state": "TX", "level": "Local",
     "status": "Proposed", "when": "Aug 3, 2026",
     "note": "Citizen petition for an 18-month moratorium on hyperscale data "
             "centers inside city limits, filed by Citizens of Lubbock Against "
             "Data Centers ('Save Lubbock') with about 3,000 signatures "
             "against a 2,410 threshold; the city verified them. Council takes "
             "it up Aug 25, 2026 — and if the council votes it down the "
             "measure can go to voters at the November election",
     "lat": 33.58, "lon": -101.86, "expires": None, "as_of": "2026-08-23",
     "source": "https://www.fox34.com/2026/08/18/data-center-moratorium-petition-heads-lubbock-city-council/"},
    {"locality": "Virginia Beach", "state": "VA", "level": "Local",
     "status": "Enacted", "when": "Aug 18, 2026",
     "note": "12-month pause on new data center applications, 10-0, ending "
             "early if the council adopts a data center ordinance first. Aimed "
             "at larger-scale and hyperscale proposals; does not affect the "
             "existing Globalinx facility. Staff told the council the city has "
             "no established definitions, setbacks or noise thresholds yet. "
             "Reported as a Tuesday vote in coverage published before Aug 20; "
    ...
    {"locality": "Lyon County", "state": "KS", "level": "Local",
     ...
     "note": "Resolution 12-26: 6-month pause on new data center and battery "
             "energy storage projects, unanimous, running through Jan 22, "
             "2027, to let the county strengthen zoning rules. A companion "
             "Resolution 13-26 pauses utility-scale solar through Dec 1, 2026. "
             "Unincorporated areas only — it does not reach Emporia's Flint "
             "Hills Digital Campus. Outlets split on the vote date between "
             "Thu Jul 23 and Fri Jul 24; Jul 23 is the Thursday",
     "lat": 38.40, "lon": -96.18, "expires": "2027-01-22", "as_of": "2026-08-23",
     "source": "https://www.emporiagazette.com/free/article_6a9583e6-0fba-4bb8-a30e-e0bbb928a316.html"},
    {"locality": "Emporia", "state": "KS", "level": "Local",
     "status": "Proposed", "when": "Aug 20, 2026",
     "note": "Citizen initiative to ban high-impact data centers, ordered onto "
             "the Nov 2026 ballot by the Lyon County District Court after the "
             "city commission asked the court to review it. The petition "
             "followed zoning changes the commission approved earlier in 2026 "
             "that would allow data centers in the city. NOT settled: the "
             "declaratory judgment action on whether the measure is a proper "
             "subject for citizen initiative under Kansas law is still "
             "pending, and a yes vote may not take effect until it is decided. "
             "A parallel petition on battery energy storage is also before the "
             "court. Distinct from the Lyon County resolution, which covers "
             "unincorporated land only",
     "lat": 38.40, "lon": -96.18, "expires": None, "as_of": "2026-08-23",
     "source": "https://www.wibw.com/2026/08/20/emporia-data-center-petition-question-be-placed-november-ballot-pending-court-ruling/"},
    {"locality": "Lyon County", "state": "KY", "level": "Local",
     "status": "Enacted", "when": "Aug 2026",
     "note": "Data center moratorium ordinance passed unanimously by the "
             "fiscal court, which will form a committee on environmental "
             "impact and utility use; reported as delaying inquiries for up to "
             "two years, modelled on Allen County's 2-year ordinance. "
             "Magistrates and Judge-Executive Jaime Green-Smith said the Lake "
             "Barkley area may be unsuitable for a data center. No outlet gave "
             "the vote date or an end date, so none is recorded here",
    ...
    {"locality": "Mount Pleasant", "state": "SC", "level": "Local", "status": "Proposed", "when": None, "note": "Planning Commission recommended 120-day moratorium on data center applications (Aug 31, 2026); full Town Council vote pending. Proactive — no current proposals.", "lat": 32.79, "lon": -79.86, "expires": None, "as_of": "2026-09-06", "source": "https://abcnews4.com/news/local/mt-pleasant-planning-commission-recommends-120-day-data-center-moratorium-community-decides-on-controversy-topic-of-discussion-charleston-south-carolina-lowcountry-news-trending-viral"},
    {"locality": "Lowndes County", "state": "GA", "level": "County", "status": "Enacted", "when": "2026-08-26", "note": "60-day moratorium on data center permits in unincorporated county, passed while commissioners develop a comprehensive data center ordinance. Residents had requested 6 months.", "lat": 30.83, "lon": -83.28, "expires": "2026-10-25", "as_of": "2026-09-06", "source": "https://valdostadailytimes.com/2026/08/26/lowndes-county-approves-60-day-data-center-moratorium/"},
    {"locality": "Lowell", "state": "MA", "level": "Local", "status": "Enacted", "when": "2026-03-10", "note": "360-day moratorium (10-0 vote) on new data center construction, development, and expansion. First in Massachusetts. Extendable by 180 days. Markley Group challenged it; court separately paused 4 diesel generators at the existing facility on Aug 11.", "lat": 42.63, "lon": -71.32, "expires": "2027-03-05", "as_of": "2026-09-06", "source": "https://www.nbcboston.com/boston-business-journal/lowell-imposes-moratorium-on-data-centers-targeting-states-largest-facility/3913800/"},
    {"locality": "Caddo Parish", "state": "LA", "level": "County", "status": "Rejected", "when": "2026-09-01", "note": "Commissioners voted 6-4 (2 absent) against referring a proposed moratorium (Resolution 53) to the Planning & Zoning Commission. The moratorium would have paused data center construction in commercially/industrially zoned unincorporated areas.", "lat": 32.58, "lon": -93.85, "expires": None, "as_of": "2026-09-06", "source": "https://thecentersquare.com/louisiana/article_3f44b5fa-479c-4ca5-9e9e-1e770fe099aa.html"},
    {"locality": "Salisbury", "state": "MD", "level": "Local", "status": "Proposed", "when": None, "note": "Planning Commission recommended 1-year moratorium on data center development (Aug 14, 2026); City Council vote pending. Mayor supports the pause.", "lat": 38.36, "lon": -75.6, "expires": None, "as_of": "2026-09-06", "source": "https://www.wboc.com/news/salisbury-planning-commission-recommends-one-year-data-center-moratorium/article_2778f1dd-058a-44d5-95af-5d90e9a09207.html"},
    ...
    {"locality": "Trumbull", "state": "CT", "level": "Local", "status": "Proposed", "when": None, "note": "Residents petitioned (1,460+ signatures) for 1-year moratorium on data center construction/expansion. Text change petition filed with Planning & Zoning Commission; PZC hearing pending. Targets $200M modernization of former Nasdaq site.", "lat": 41.24, "lon": -73.2, "expires": None, "as_of": "2026-09-06", "source": "https://www.stamfordadvocate.com/news/trumbull/article/trumbull-data-center-moratorium-residents-petition-22388790.php"},
    ...
    {"locality": "Covington", "state": "GA", "level": "City", "status": "Enacted", "when": "2026-01-20", "note": "180-day moratorium enacted unanimously Jan 20 (initiated Jan 5); city will not accept new data center requests. Also initiated process to require special use permits for data centers in all zones. Upstream marks as 'active'.", "lat": 33.5968, "lon": -83.8602, "expires": "2026-07-19", "as_of": "2026-09-06", "source": "https://www.rockdalenewtoncitizen.com/news/covington-enacts-moratorium-on-data-center-permits/article_5054a82f-c4e7-47ab-b7b1-3892e30a4047.html"},
    {"locality": "Floyd County", "state": "GA", "level": "County", "status": "Enacted", "when": "2026-06-09", "note": "80-day moratorium on data center permits, unanimously approved. Halts issuance of permits for construction or expansion. Draft ordinance for Unified Land Development Code establishing data center standards expected by late August.", "lat": 34.2632, "lon": -85.1894, "expires": "2026-08-28", "as_of": "2026-09-06", "source": "https://www.northwestgeorgianews.com/rome/news/local/floyd-county-commission-enacts-80-day-moratorium-on-new-data-centers/article_f6a7cc37-9486-42af-85b0-5705c980691e.html"},
    ...
    {"locality": "Grundy County", "state": "TN", "level": "County", "status": "Enacted", "when": "2026-05-18", "note": "Two-year moratorium on data centers, crypto mining, and high-impact data processing in unincorporated areas; approved unanimously by county commission", "lat": 35.388, "lon": -85.764, "expires": "2028-05-18", "as_of": "2026-09-06", "source": "https://www.sewaneemessenger.com/headlines/?post_id=3474&title=trend-setting-grundy-county-data-center-moratorium"},
    {"locality": "Morgan County", "state": "TN", "level": "County", "status": "Enacted", "when": "2026-06-12", "note": "Two-year moratorium on data centers capable of 10+ MW peak demand; county commission proactive measure, no proposals pending", "lat": 36.137, "lon": -84.616, "expires": "2028-06-12", "as_of": "2026-09-06", "source": "https://www.themountainpress.com/morgan/news/morgan-county-passes-resolution-preventing-ai-data-centers-for-2-years/article_a632d5e3-a4c0-57c4-aba6-a660f76ccca6.html"},
    {"locality": "Shelbyville", "state": "TN", "level": "Local", "status": "Enacted", "when": "2026-07-07", "note": "Moratorium on data centers and cryptocurrency mining plants; duration not specified in available sources", "lat": 35.483, "lon": -86.461, "expires": None, "as_of": "2026-09-06", "source": "https://www.wsmv.com/video/2026/07/09/shelbyville-city-council-passes-data-center-moratorium/", "term": "fixed_undated"},
    {"locality": "Hamilton County", "state": "TN", "level": "County", "status": "Enacted", "when": "2026-07-15", "note": "One-year moratorium on new data centers in unincorporated areas only; does not affect approved Chattanooga projects", "lat": 35.045, "lon": -85.267, "expires": "2027-07-15", "as_of": "2026-09-06", "source": "https://www.local3news.com/local-news/update-hamilton-county-approves-one-year-moratorium-on-new-data-centers-in-unincorporated-areas/article_9ff722e4-a174-4361-95c3-0cce1db669bc.html"},
    {"locality": "Warren County", "state": "TN", "level": "County", "status": "Enacted", "when": "2026-06-22", "note": "12-month moratorium on new data center proposals; separate from McMinnville's 18-month city moratorium", "lat": 35.681, "lon": -85.779, "expires": "2027-06-22", "as_of": "2026-09-06", "source": "https://servercountry.org/policy/tennessee/"},
    {"locality": "White County", "state": "TN", "level": "County", "status": "Enacted", "when": "2026-07-20", "note": "Ban on data centers and data mining facilities; did not go through formal zoning process; enforcement challenged by 4.9 MW crypto proposal", "lat": 35.949, "lon": -85.5, "expires": None, "as_of": "2026-09-06", "source": "https://www.wsmv.com/2026/08/10/white-county-executive-reviews-legal-options-after-proposed-data-center-bypasses-local-ban/", "term": "standing"},
    {"locality": "Mitchell County", "state": "IA", "level": "County", "status": "Enacted", "when": "2025-11-25", "note": "Resolution #1336-25; moratorium on data centers until Dec 31, 2026. Voted 4-1 (Frein, Marzen, Hartogh, Wherry yes; Hendrickson nay).", "lat": 43.2844, "lon": -92.811, "expires": "2026-12-31", "as_of": "2026-09-06", "source": "https://mitchellcounty.iowa.gov/wp-content/uploads/Board-Proceedings-11-25-25-2.pdf"},
    {"locality": "Taylor County", "state": "IA", "level": "County", "status": "Enacted", "when": "2026-07-30", "note": "Ordinance No. 40; 12-month moratorium on data centers, solar, battery storage, and mineral rights developments.", "lat": 40.6686, "lon": -94.7221, "expires": "2027-07-30", "as_of": "2026-09-06", "source": "https://taylorcounty.iowa.gov/data-solar-etc-moratorium-draft-passed-july-30-2026/"},
    {"locality": "McPherson County", "state": "KS", "level": "County", "status": "Enacted", "when": "2026-08-31", "note": "Resolution 2026-21; permanent ban on data centers and utility-scale battery storage in unincorporated areas. Voted 3-0. Replaced earlier moratorium from summer 2025.", "lat": 38.3709, "lon": -97.6642, "expires": None, "as_of": "2026-09-06", "source": "https://www.citizenjournal.us/mcpherson-county-bans-data-centers-and-utility-scale-battery-storage/", "term": "standing"},
    {"locality": "Riley County", "state": "KS", "level": "County", "status": "Enacted", "when": "2026-05-18", "note": "6-month moratorium on data centers and battery energy storage systems through Nov 12, 2026.", "lat": 39.1836, "lon": -96.5717, "expires": "2026-11-12", "as_of": "2026-09-06", "source": "https://1350kman.com/2026/05/end-date-set-for-riley-countys-data-center-moratorium/"},
    {"locality": "Saline County", "state": "KS", "level": "County", "status": "Enacted", "when": "2026-03-17", "note": "3-year moratorium on data centers, nuclear power, and hydrogen energy facilities in unincorporated areas through March 1, 2029.", "lat": 38.8403, "lon": -97.6114, "expires": "2029-03-01", "as_of": "2026-09-06", "source": "https://salinapost.com/posts/72efeb72-d4d2-4a40-bb06-f445635cd6d4"},
    {"locality": "Bullitt County", "state": "KY", "level": "County", "status": "Enacted", "when": "2026-07-16", "note": "12-month moratorium on data centers in unincorporated areas; can be terminated or extended by Fiscal Court.", "lat": 37.9884, "lon": -85.7155, "expires": "2027-07-16", "as_of": "2026-09-06", "source": "https://spectrumnews1.com/ky/louisville/news/2026/07/21/bullitt-county-data-center-moratorium"},
    {"locality": "Oldham County", "state": "KY", "level": "County", "status": "Enacted", "when": "2025-07-02", "note": "150-day moratorium voted 4-2; extended Nov 18, 2025 indefinitely until regulations are adopted. Driven by opposition to Western Hospitality Partners $6B 'Project Lincoln'.", "lat": 38.4085, "lon": -85.3788, "expires": None, "as_of": "2026-09-06", "source": "https://www.lpm.org/news/2025-07-02/oldham-county-passes-sweeping-data-center-moratorium-executive-fired-over-recording", "term": "until_event"},
    {"locality": "Independence", "state": "MO", "level": "City", "status": "Enacted", "when": "2026-07-06", "note": "180-day moratorium on new data center and battery energy storage permits. Does not affect previously approved Nebius project.", "lat": 39.0911, "lon": -94.4155, "expires": "2027-01-02", "as_of": "2026-09-06", "source": "https://www.independencemo.gov/news/city-council-approves-temporary-moratorium-new-data-center-and-battery-energy-storage-system-applications"},
    {"locality": "Marion County", "state": "MO", "level": "County", "status": "Rescinded", "when": "2026-06-15", "note": "12-month moratorium enacted June 15; lifted Aug 26, 2026, replaced by task force to study data center regulations.", "lat": 39.7942, "lon": -91.5232, "expires": None, "as_of": "2026-09-06", "source": "https://www.nemonews.net/2026/07/22/marion-county-commission-approves-truck-wash-rezoning-data-center-moratorium/"},
    {"locality": "Surry County", "state": "NC", "level": "County", "status": "Enacted", "when": "2026-07-21", "note": "2-year moratorium replacing earlier 60-day pause from June 2026. Steering committee appointed to study impacts. Unanimous vote.", "lat": 36.396, "lon": -80.7226, "expires": "2028-07-21", "as_of": "2026-09-06", "source": "https://www.wfdd.org/environment/2026-07-21/surry-county-enacts-two-year-data-center-development-moratorium"},
    {"locality": "Wilson", "state": "NC", "level": "City", "status": "Enacted", "when": "2026-05-21", "note": "1-year moratorium on large data center development approvals. Unanimous vote. UDO text amendments to follow.", "lat": 35.7212, "lon": -77.9156, "expires": "2027-05-21", "as_of": "2026-09-06", "source": "https://www.wilsontimes.com/news/city-council-approves-data-center-moratorium-25f2bcbd"},
    {"locality": "Brookville", "state": "PA", "level": "Borough", "status": "Enacted", "when": "2026-06-17", "note": "180-day moratorium on data centers and borough water use for data centers. Two potential data center projects prompted action. Unanimous vote.", "lat": 41.1614, "lon": -79.0828, "expires": "2026-12-14", "as_of": "2026-09-06", "source": "https://www.explorejeffersonpa.com/local/2026/06/17/brookville-approves-180-day-data-center-moratorium-over-water-concerns-176517/"},
    {"locality": "Center Township", "state": "PA", "level": "Local", "status": "Enacted", "when": "2026-06-10", "note": "180-day curative amendment halting data center and power generation plant development in Butler County. Unanimous vote.", "lat": 40.7842, "lon": -80.0, "expires": "2026-12-07", "as_of": "2026-09-06", "source": "https://www.butlereagle.com/20260611/center-township-places-moratorium-on-data-center-development/"},
    {"locality": "Muncy Township", "state": "PA", "level": "Local", "status": "Enacted", "when": "2026-05-01", "note": "9-month moratorium on data centers in Lycoming County township; prompted by Danko Holdings/Fishlips LLC proposal for 100-acre, 3-building facility.", "lat": 41.2067, "lon": -76.7856, "expires": "2027-02-01", "as_of": "2026-09-06", "source": "https://www.sungazette.com/news/top-news/2026/05/muncy-township-passes-9-month-moratorium-on-data-centers/"},
    {"locality": "Chester County", "state": "SC", "level": "County", "status": "Enacted", "when": "2026-07-21", "note": "6-month countywide pause on data center applications. Workshops planned Aug 13 and Sep 28. 8-10 data center inquiries received.", "lat": 34.7046, "lon": -81.214, "expires": "2027-01-21", "as_of": "2026-09-06", "source": "https://www.wbtv.com/2026/07/21/chester-county-council-approves-6-month-data-center-moratorium/"},
    {"locality": "Greenwood County", "state": "SC", "level": "County", "status": "Enacted", "when": "2026-07-21", "note": "1-year moratorium blocking new data center approvals. Voted 4-3. Followed denial of text amendment allowing data centers as conditional use.", "lat": 34.1954, "lon": -82.1618, "expires": "2027-07-21", "as_of": "2026-09-06", "source": "https://www.foxcarolina.com/2026/07/21/greenwood-co-council-approves-final-reading-one-year-moratorium-data-centers/"},
    {"locality": "Archuleta County", "state": "CO", "level": "County", "status": "Enacted", "when": "2026-06-16", "note": "Resolution 2026-47; 6-month moratorium on data centers. Unanimous vote. County infrastructure and water cannot support data centers.", "lat": 37.2694, "lon": -107.0098, "expires": "2026-12-16", "as_of": "2026-09-06", "source": "https://www.pagosasun.com/stories/moratorium-on-data-centers-approved-by-county-board,140916"},
    {"locality": "South Fork", "state": "CO", "level": "Local", "status": "Enacted", "when": "2026-06-18", "note": "1-year moratorium on data center site development plans and zoning permits. No data center applications received; preemptive action.", "lat": 37.6714, "lon": -106.6428, "expires": "2027-06-18", "as_of": "2026-09-06", "source": "https://www.alamosacitizen.com/costilla-county-south-fork-getting-ahead-of-ai-data-centers/"},
    {"locality": "Madison County", "state": "FL", "level": "County", "status": "Enacted", "when": "2026-07-22", "note": "1-year moratorium on construction and permitting of large-scale data centers. Unanimous vote.", "lat": 30.4694, "lon": -83.413, "expires": "2027-07-22", "as_of": "2026-09-06", "source": "https://www.greenepublishing.com/county-commission-passes-data-center-moratorium/"},
    {"locality": "Oakley", "state": "CA", "level": "City", "status": "Enacted", "when": "2026-04-15", "note": "Initial 45-day urgency ordinance Apr 15; extended May 16 for 10 months 15 days (through ~Apr 2027). Working toward permanent ban. Voted 5-0 on extension.", "lat": 37.9974, "lon": -121.7125, "expires": "2027-04-01", "as_of": "2026-09-06", "source": "https://contracosta.news/2026/05/16/oakley-agrees-to-extend-moratorium-on-data-centers-for-1-year/"},
    {"locality": "Delta County", "state": "MI", "level": "County", "status": "Enacted", "when": "2026-07-23", "note": "12-month moratorium on data centers and cryptocurrency mining; county board approved unanimously after planning commission forwarded recommendation; county to develop zoning standards during pause", "lat": 45.7917, "lon": -87.0644, "expires": "2027-07-23", "as_of": "2026-09-06", "source": "https://www.miningjournal.net/news/local/2026/07/delta-county-board-oks-moratorium-on-data-centers/"},
    {"locality": "Forsyth Township", "state": "MI", "level": "Local", "status": "Enacted", "when": "2026-06-25", "note": "12-month moratorium on data center construction; board passed at crowded meeting; township lacks data center zoning regulations and has no pending applications", "lat": 46.2728, "lon": -87.3767, "expires": "2027-06-25", "as_of": "2026-09-06", "source": "https://www.uppermichiganssource.com/2026/06/26/forsyth-township-board-passes-moratorium-regarding-data-centers-crowded-meeting/"},
    {"locality": "Houghton", "state": "MI", "level": "Local", "status": "Enacted", "when": "2026-07-09", "note": "One-year moratorium on permitting, approval, or installation of data center facilities; city council voted unanimously; no proposals pending but city acted proactively to develop regulations", "lat": 47.1211, "lon": -88.5694, "expires": "2027-07-09", "as_of": "2026-09-06", "source": "https://www.uppermichiganssource.com/2026/07/09/houghton-city-council-approves-temporary-data-center-moratorium/"},
    {"locality": "Huron County", "state": "MI", "level": "County", "status": "Enacted", "when": "2026-05-27", "note": "Three-year (36-month) moratorium on data centers; planning commission unanimously extended original 6-month proposal to 36 months at April 1 hearing after public demand; county commissioners approved in May; concerns center on farmland preservation and resource use", "lat": 43.9414, "lon": -83.0358, "expires": "2029-05-27", "as_of": "2026-09-06", "source": "https://huroncountyview.com/articles/huron-county-planners-advance-moratorium-on-data-centers/"},
    {"locality": "Sault Ste. Marie Tribe of Chippewa Indians", "state": "MI", "level": "Local", "status": "Enacted", "when": "2026-04-07", "note": "Indefinite moratorium prohibiting development, approval, or operation of AI data centers on tribal lands; board of directors voted unanimously; remains in effect unless lifted by subsequent resolution; concerns about resource strain and long-term land use impacts", "lat": 46.4953, "lon": -84.3453, "expires": None, "as_of": "2026-09-06", "source": "https://www.myupnow.com/news/sault-tribe-directors-vote-in-indefinite-pause-on-data-center-development/article_51356dac-7efb-4e02-b7fd-6802f439cfd8.html", "term": "standing"},
    {"locality": "Gorham", "state": "ME", "level": "Local", "status": "Enacted", "when": "2026-06-02", "note": "Town Council voted 7-0 for 180-day moratorium on data center development; extendable another 180 days. Council later voted (Sep 4) to consider permanent ban", "lat": 43.6795, "lon": -70.4441, "expires": "2026-11-29", "as_of": "2026-09-06", "source": "https://www.gorhamtimes.com/town-council-meeting-june-2/"},
    {"locality": "Waite Park", "state": "MN", "level": "City", "status": "Enacted", "when": "2026-05-04", "note": "1-year moratorium on data center development, unanimous. Exempts telecom shelters under 300 sq ft. Staff to study impacts and draft regulations", "lat": 45.5569, "lon": -94.2244, "expires": "2027-05-04", "as_of": "2026-09-06", "source": "https://www.stcloudlive.com/news/local/waite-park-city-council-unanimously-backs-year-long-data-center-moratorium"},
    {"locality": "Galloway Township", "state": "NJ", "level": "Local", "status": "Enacted", "when": "2026-07-14", "note": "Ordinance 2172-2026: 6-month moratorium on data center approval, development, construction and expansion. Introduced Jun 16, adopted Jul 14", "lat": 39.4918, "lon": -74.4851, "expires": "2027-01-14", "as_of": "2026-09-06", "source": "https://www.gtnj.org/index.php/i-want-to/find-a-form-or-document/public-notices-1/municipal-clerk-notices/2871-introduction-ordinance-2172-2026-data-centers/file"},
    {"locality": "Highland", "state": "NY", "level": "Local", "status": "Enacted", "when": "2026-06-18", "note": "Local Law No. 1 of 2026: 12-month moratorium on large-scale data center development, extendable to 24 months. Sullivan County town; preemptive, no project proposed", "lat": 41.5084, "lon": -74.8557, "expires": "2027-06-18", "as_of": "2026-09-06", "source": "https://townofhighlandny.gov/local-law-no-1-of-2026-notice/"},
    {"locality": "Seminole Nation of Oklahoma", "state": "OK", "level": "Local", "status": "Enacted", "when": "2026-03-07", "note": "General Council voted 24-0 for indefinite moratorium on AI data center development on tribal lands. Bars any inquiries or development concerning data centers of any size. Triggered by startup NDA request", "lat": 35.3665, "lon": -96.9486, "expires": None, "as_of": "2026-09-06", "source": "https://nativenewsonline.net/sovereignty/seminole-nation-of-oklahoma-passes-moratorium-on-data-centers/", "term": "standing"},
    {"locality": "Saugatuck Township", "state": "MI", "level": "Local", "status": "Enacted", "when": "2026-02-11", "note": "Ordinance 2026-01: 6-month moratorium on data center building permits and zoning applications, or until zoning amendment adopted. Voted 4-0 (one absent)", "lat": 42.65, "lon": -86.20, "expires": "2026-08-11", "as_of": "2026-09-06", "source": "https://saugatucktownshipmi.gov/wp-content/uploads/2026/04/20260211-Meeting-minutes-APPROVED-SIGNED.pdf"},
    {"locality": "Hagar Township", "state": "MI", "level": "Local", "status": "Enacted", "when": "2026-07-13", "note": "Moratorium on data centers approved at board meeting; Berrien County. Source is paywalled but headline and snippets confirm", "lat": 42.2047, "lon": -86.3811, "expires": None, "as_of": "2026-09-06", "source": "https://www.tricityrecord.com/post/hagar-township-board-approves-data-center-moratorium-hears-concerns-over-drain-district-assessments", "term": "fixed_undated"},
    {"locality": "Lake Township", "state": "MI", "level": "Local", "status": "Enacted", "when": "2026-07-16", "note": "Ordinance 2026-01: temporary moratorium on new or expanded data centers. Voted 4-0 (clerk absent). Huron County township; separate from county-level 3-year moratorium", "lat": 43.956, "lon": -83.184, "expires": None, "as_of": "2026-09-06", "source": "https://www.laketownship.net/download/23077/minutes-july-2026.pdf", "term": "fixed_undated"},
    {"locality": "Webster Township", "state": "MI", "level": "Local", "status": "Enacted", "when": "2026-04-21", "note": "Ordinance 26-02: 1-year moratorium on data centers and battery energy storage systems (BESS). Washtenaw County township", "lat": 42.39, "lon": -83.95, "expires": "2027-04-21", "as_of": "2026-09-06", "source": "https://cms9files.revize.com/webstertwpmi/2026-04-21%20Ordinance%20No.%2026-02%20Data%20Center%20Moratorium%20Notice%20of%20Adoption.pdf"},
    {"locality": "Lycoming County", "state": "PA", "level": "County", "status": "Enacted", "when": "2026-06-18", "note": "Curative amendment under PA MPC Section 609.2; county zoning declared invalid for lack of data center standards. 180-day window. Covers 19 municipal partners. Separate from Muncy Township moratorium", "lat": 41.34, "lon": -77.06, "expires": "2026-12-15", "as_of": "2026-09-06", "source": "https://www.sungazette.com/news/top-news/2026/06/lycoming-county-declares-data-center-ordinance-invalid-seeks-curative-amendment-2/"},
    {"locality": "Warrington Township", "state": "PA", "level": "Local", "status": "Enacted", "when": "2026-05-13", "note": "Resolution 2026-09: curative amendment under PA MPC Section 609.2. York County (not Bucks). Administrative pause since Mar 11; formally ratified May 13", "lat": 40.0547, "lon": -76.9936, "expires": None, "as_of": "2026-09-06", "source": "https://warringtontwp.org/wp-content/uploads/2026/06/2026-15-Warrington-Follow-up-Resolution-Moratorium.pdf", "term": "until_event"},
    {"locality": "Door County", "state": "WI", "level": "County", "status": "Enacted", "when": "2026-05-26", "note": "1-year moratorium on data centers and battery energy storage in unincorporated areas; board retains option to extend", "lat": 44.88, "lon": -87.38, "expires": "2027-05-26", "as_of": "2026-09-06", "source": "https://wisconsinwatch.org/2026/04/latest-wisconsin-data-center-news-you-might-have-missed/"},
]
...
# How a moratorium's term is bounded. `expires` alone can't carry this: a null
# there currently means three very different things at once — a permanent ban
# (the strongest precedent a resident can cite), a pause that ends when some
# condition is met, and "nobody has researched this yet" — and collapsing them
# makes the best rows look like the worst. Adapted from the duration taxonomy
# in Moratorium Nation (Bommarito 2026, CC-BY-4.0), which splits the same
# problem into fixed_days / until_date / until_event / indefinite.
#
# `until_date` is derived, never stored — a row with an `expires` has one by
# definition. The rest are declared per-row via the optional `term` key, and
# an undeclared row is `unknown`, never guessed: the note text is suggestive
# ("6-month moratorium") but a regex over it mislabels a 45-day pause as a
# permanent ban, so classification is a human read, same as `source`/`as_of`.
TERM_KINDS = {
    "until_date": "Runs to a documented date",
    "standing": "No end date by design — a permanent ban or standing statute",
    "until_event": "Runs until a condition is met, not to a date",
    "fixed_undated": "A stated duration, but the end date isn't recorded here",
    "unknown": "Term not documented",
}


def moratorium_term(expires, term):
    """(kind, label) for how a row's term is bounded. `until_date` wins over
    any declared `term` — a documented end date is the strongest statement
    available and moratorium_status() is already deriving from it."""
    if has_value(expires):
        return "until_date", TERM_KINDS["until_date"]
    kind = str(term).strip() if has_value(term) else ""
    if kind not in TERM_KINDS or kind == "until_date":
        kind = "unknown"
...
_mora_term = [moratorium_term(e, t)
...
#
# The 2026-08-05 pass stopped at Google/Meta/Microsoft/AWS/QTS. Everything
# from CoreWeave down was a later bulk addition that reintroduced the same
# failure in a form the audit could not see: every row carried a plausible
# source URL, so verify_moratoriums.py counted it verified, but 17 of 36 URLs
# 404'd and several had never existed at all (a Henry Herald slug ending
# `article_e2c5f5e0-1234-5678-9abc-def012345678`). All of it was re-researched
# and rewritten 2026-08-23 against live primary sources, and the facts moved
# with the sources — the Yorkville water cap is 2026 and 500k->40k gpd with a
# 1.7x penalty trigger, not a bare "40,000 gal/day" in 2023; Ashville's Ohio
# Supreme Court case was three residents seeking a referendum, not the school
# district fighting an abatement; Vantage's "Pittsboro, NC" campus is
# Pittsboro, *Indiana*, approved 5-0. One entry was deleted rather than fixed:
# Stack Infrastructure / Prince William County, which credited Stack with a
# supervisors' denial of the Digital Gateway that never happened — the county
# approved it, and it was QTS and Compass whose rezoning was later voided on
# public-notice grounds.
#
# The rule the audit now enforces (`--offline` is a convenience, not the
# check): a URL that resolves is not a source. If the page does not say the
# thing, the row is fabricated no matter how healthy the link check looks.
COMPANY_CONCESSIONS = {
    "Google": {
        "pattern": (
    ...
    "CoreWeave": {
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Lancaster, PA", "year": "2025",
             "what": "Community benefits agreement worth $20M in payments to "
                     "the city, paid in installments at construction financing "
                     "and start of operation for each building: half to "
                     "nonprofits for economic development, half toward climate "
                     "goals. Also a 100% renewable energy commitment backed by "
                     "a $10M letter of credit, a local hiring plan targeting "
                     "2,000 construction and 350 permanent jobs, and limits on "
                     "noise, light, water use and air pollution. Read the "
                     "enforcement clause before copying it: only the city can "
                     "sue over a violation, so residents have no direct "
                     "recourse on noise, and activists said the city ignored "
                     "requests to include residents in the negotiation.",
            ...
            {"as_of": "2026-08-23", "where": "Kenilworth, NJ", "year": "2025",
             "what": "A $1.8B, 400,000 sq ft facility on the former Merck "
                     "campus on Galloping Hill Road. Residents said they "
                     "learned of it only once construction was already "
                     "underway, and raised pollution and utility-cost "
                     "concerns; no community benefits agreement was "
                     "negotiated.",
    ...
    "xAI (Colossus)": {
        "pattern": (
            ...
            "gas turbines before any public meeting. Speed is xAI's entire "
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Memphis, TN", "year": "2025",
             "what": "City Council passed an allocation ordinance directing "
                     "25% of the property tax revenue from qualifying AI "
                     "facilities — capped at $100M — to public benefit "
                     "projects within a 5-mile radius of the site, with 1% "
                     "set aside for environmental improvement. The ordinance "
                     "text is on the city's own site; read it for the "
                     "eligibility thresholds before citing the 25% figure.",
             "sources": ["https://memphistn.gov/wp-content/uploads/2025/07/xAI-Allocation-Ordinance47043091-1.pdf"]},
            {"as_of": "2026-08-23", "where": "Memphis, TN", "year": "2025",
             "what": "Not a concession — the counter-example. Shelby County "
                     "Health Department issued a permit on 2 July 2025 for 15 "
                     "methane gas turbines, after turbines had already been "
                     "running. The Southern Environmental Law Center appealed "
                     "for the NAACP and Young, Gifted and Green, contesting "
                     "the department's finding that the existing turbines were "
                     "exempt 'nonroad engines'. Permits issued after the fact "
                     "are the pattern to raise at your own hearing.",
             "sources": ["https://www.selc.org/press-release/groups-appeal-permit-for-xais-south-memphis-data-center-decisions-around-unpermitted-methane-gas-turbines/"]},
        ],
    },
    "OpenAI · Oracle (Stargate)": {
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Abilene, TX", "year": "2025",
             "what": "Abilene granted an 85% tax abatement on the $3.5B "
                     "campus. The agreement requires Crusoe and Lancium to "
                     "create 357 full-time jobs at a minimum salary of "
                     "$57,600 — the enforceable number, against the 1,000 "
                     "long-term jobs quoted publicly. No community benefits "
                     "agreement was negotiated, and by August 2026 local "
                     "reporting tied the buildout to an Abilene housing "
                     "crisis.",
             "sources": ["https://www.kut.org/energy-environment/2026-08-12/abilene-tx-stargate-ai-data-center-economy-housing-crisis",
                         "https://www.houstonpublicmedia.org/articles/news/texas/2026/08/12/559282/abilene-tx-stargate-ai-data-center-economy-housing-crisis/"]},
            {"as_of": "2026-08-23", "where": "Childress, TX", "year": "2025",
             "what": "Crusoe and Lancium announced a 1 GW campus with "
                     "community investment and local hiring language. This is "
                     "the developer's own announcement and no binding terms "
                     "have been published — treat it as a press release, not "
                     "a commitment.",
    ...
    "Digital Realty": {
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Atlanta (West End), GA", "year": "2026",
             "what": "For a $500M campus at 713 Ralph David Abernathy Blvd, "
                     "Digital Realty offered a $10M community investment fund "
                     "and a $5M community trust, and estimated $20M to "
                     "remediate the brownfield to commercial standards. It was "
                     "not enough to carry the vote: NPU-V recommended against "
                     "the rezoning 105-87 and the City Council's zoning "
                     "committee tabled the legislation 6-1 in July 2026. An "
                     "offer tabled is not an offer won — cite it as an opening "
                     "bid, not a precedent.",
             "sources": ["https://www.ajc.com/business/2026/07/atlanta-data-center-tabled-but-developer-remains-committed-to-vision/",
                         "https://roughdraftatlanta.com/2026/08/05/atlanta-residents-protest-digital-realty/"]},
            {"as_of": "2026-08-23", "where": "Franklin Park (Chicago), IL", "year": "2019",
             "what": "Ground-floor generator noise exceeded the local "
                     "ordinance and the company was fined $300. It installed a "
                     "15-foot sound barrier around the rooftop fans, though a "
                     "survey suggested that would barely change levels in the "
                     "apartments overlooking the building. The size of the "
                     "fine is the point: post-construction enforcement is not "
                     "a substitute for a pre-approval condition.",
             "sources": ["https://www.datacenterdynamics.com/en/news/chicago-residents-complain-of-noise-from-digital-realty-data-center/"]},
        ],
    },
    "Equinix": {
        "pattern": (
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Hampton, GA", "year": "2026",
             "what": "Signed a 20-year take-or-pay contract with Central "
                     "Georgia Electric Membership Corporation under which "
                     "Equinix pays 100% of the co-op's costs of serving the "
                     "campus — a new high-voltage substation, two new "
                     "transmission lines, early engineering — including "
                     "unforeseen and shifting costs, so members don't carry "
                     "them. Announced by Equinix on 6 Aug 2026; this is a "
                     "utility contract, not a land-use proffer, so the thing "
                     "to ask your own utility for is the cost-allocation "
                     "term.",
             "sources": ["https://newsroom.equinix.com/2026-08-06-Equinix-Partners-with-Central-Georgia-Electric-Membership-Corporation-to-Protect-Ratepayers"]},
            {"as_of": "2026-08-23", "where": "Dallas, TX", "year": "2019",
             "what": "Dallas City Council approved (23 Jan 2019) a ten-year "
                     "50% abatement on added real property value plus a "
                     "five-year 50% abatement on business personal property "
                     "for the second phase at 2000 North Stemmons Freeway. "
                     "The city put revenue forgone at $6,051,331 over ten "
                     "years. No community benefits were attached — a plain "
                     "abatement, and a useful example of what the default "
                     "looks like when nobody negotiates.",
             "sources": ["https://citysecretary2.dallascityhall.com/resolutions/2019/01-23-19/19-0229.pdf"]},
        ],
    },
    "Vantage": {
        "pattern": (
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Pittsboro, IN", "year": "2025",
             "what": "The Town Council voted 5-0 in March 2025 to rezone "
                     "roughly 626 acres of Smith Family Farms from "
                     "agricultural to warehouse industrial, with about 285 "
                     "acres for the campus. Approved unanimously with no "
                     "community benefits agreement — farmland conversion at "
                     "this scale does not automatically produce leverage.",
             "sources": ["https://www.insideindianabusiness.com/articles/pittsboro-officials-ok-rezoning-of-626-acre-site-for-proposed-data-center-campus"]},
            {"as_of": "2026-08-23", "where": "Sterling, VA (Loudoun County)", "year": "2026",
             "what": "After a 16 July 2026 power failure, the Ashburn II "
                     "campus ran its diesel generators for nearly 24 hours. A "
                     "neighbour measured 60 dB at his property line against "
                     "Loudoun's 55 dB night-time limit and left his home over "
                     "the fumes. No binding remediation agreement followed; "
                     "the Sterling District supervisor instead asked staff to "
                     "look at regulating backup generators. Dominion has "
                     "warned supervisors that generator runtime will rise as "
                     "grid stress grows.",
             "sources": ["https://northernvirginiamag.com/news/2026/07/21/sterling-resident-says-data-centers-generators-produced-excessive-noise-pollution/",
                         "https://www.loudounnow.com/news/sterling-residents-raise-alarms-over-off-grid-data-center/article_3481d7fd-11ef-4948-a951-8c4ee6e69f2f.html"]},
        ],
    },
    "CyrusOne": {
        "pattern": (
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Yorkville, IL", "year": "2026",
             "what": "For the 228-acre campus, CyrusOne agreed to pay the "
                     "city $15M up front on issuance of the first building "
                     "permit — most of it to Yorkville School District 115 "
                     "for school construction — and the city cut the "
                     "project's water allowance from 500,000 gallons/day to "
                     "40,000 gallons/day, with financial penalties if the "
                     "average is exceeded or any single day exceeds 1.7x the "
                     "allotment. The strongest water-cap template tracked "
            ...
            {"as_of": "2026-09-02", "where": "Aurora, IL", "year": "2026",
             "what": "After the city issued citations over chiller and "
                     ...
                     "fixes, carrying a $40,000 fine that can be reduced on "
                     "compliance. A temporary rooftop sound wall went up on "
            ...
            {"as_of": "2026-08-23", "where": "Chandler, AZ", "year": "2018-2022",
             "what": "After sustained resident complaints about a high-pitched "
                     "hum, CyrusOne wrapped chillers in acoustic blankets and "
                     "added sound attenuation panels and screen walls, and "
                     "committed to factory-fitted attenuation on new AC "
                     "units. Residents remained sceptical that measured "
                     "declines matched what they heard. Chandler later moved "
                     "to regulate data-center noise by ordinance rather than "
                     "by complaint.",
             "sources": ["https://www.eastvalleytribune.com/residents-skeptical-about-noise-declines-at-data-center/article_9edb4c85-ceb9-54e9-9b0e-ab4b6390d04e.html",
                         "https://www.datacenterdynamics.com/en/news/cyrusone-forced-to-take-action-following-noise-complaints-in-chandler-arizona/"]},
        ],
    },
    "Aligned": {
        "pattern": (
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Pataskala, OH", "year": "2026",
             "what": "Aligned said it would not seek or accept local property "
                     "tax abatements, committing instead to pay full property "
                     "taxes it estimated at $34.4M when fully operational — "
                     "the no-abatement precedent to cite. It did not carry the "
                     "room: on 3 June the planning and zoning commission voted "
                     "5-2 to recommend council reject the site plan, faulting "
                     "an application with no detail on AEP and Bloom Energy "
                     "power supply and heat and noise studies built on "
                     "modelling rather than measurements at comparable "
                     "sites. The council decision was still pending.",
             "sources": ["https://www.thereportingproject.org/pataskala-planning-board-says-city-council-should-reject-aligned-data-centers-proposal/"]},
        ],
    },
    "Switch": {
        "pattern": (
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Clark County, NV (LAS 19)", "year": "2024",
             "what": "Switch says its Las Vegas campus uses closed-loop "
                     "cooling consuming zero daily water. This is the "
                     "company's own published claim, not an audited figure — "
                     "cite it as what the operator says is achievable, which "
                     "is what makes it useful against a developer arguing "
                     "evaporative draw is unavoidable.",
             "sources": ["https://www.switch.com/las-vegas/"]},
            {"as_of": "2026-08-23", "where": "Grand Rapids, MI", "year": "2015-2022",
             "what": "Michigan's 2015 package exempted large data centers "
                     "from sales and use taxes, with job triggers written "
                     "industry-wide (400 new jobs by 2022, 1,000 by 2026) "
                     "rather than per company. A 2022 state report found "
                     "Switch had created 26 jobs against the 1,000 it "
                     "projected; the Legislature extended the exemptions to "
                     "2050 anyway, with no state audit verifying the job "
                     "growth. The lesson is the drafting: industry-wide, "
                     "unaudited triggers are not a clawback.",
             "sources": ["https://www.michigancapitolconfidential.com/news/legislature-extends-tax-breaks-for-data-center-that-brought-only-2-6-of-promised-jobs",
                         "https://bridgemi.com/michigan-environment-watch/data-centers-create-few-jobs-michigan-wants-give-them-big-tax-breaks/"]},
        ],
    },
    "Stack Infrastructure": {
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Hayward, CA", "year": "2025",
             "what": "The Planning Commission approved the SVY03A campus in "
                     "May 2025 with a $2M public benefits package — raised "
                     "from an initial $1.1M — traded for eight extra feet of "
                     "building height above the 75-foot limit, plus a water "
                     "main replacement, solar at the city's Water Resource "
                     "Recovery Facility, a bike path, and a 100% union labour "
                     "commitment (about 380 construction jobs, 41 permanent). "
                     "It never went to City Council: the zoning code treated "
                     "data centers as an office use. Check how your own code "
                     "classifies them before assuming there will be a council "
                     "vote to organise around.",
             "sources": ["https://haywardherald.org/who-approved-haywards-largest-data-center/",
                         "https://www.hayward-ca.gov/business/for-developers/data-center-development-applications"]},
        ],
    },
    "EdgeConneX": {
        "pattern": (
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Ashville, OH", "year": "2026",
             "what": "The agreement attached to residents' litigation "
                     "proposed as much as $102M in support to the village of "
                     "Ashville, Harrison Township and Teays Valley Local "
                     "Schools. Three residents challenged the village's "
                     "fast-tracked approval after the fiscal officer rejected "
                     "their referendum petition, and on 7 Aug 2026 the Ohio "
                     "Supreme Court sided with them, clearing the way for a "
                     "referendum. A package this size does not settle the "
                     "question if the procedure was wrong.",
             "sources": ["https://www.wosu.org/politics-government/2026-08-07/ohio-supreme-court-sides-with-ashville-residents-trying-to-overturn-data-center-agreement"]},
            {"as_of": "2026-08-23", "where": "Douglas County, GA", "year": "2026",
             "what": "Commissioners voted 4-1 on 7 July 2026 to deny the land "
                     "use amendment, rezoning and special use permits for a "
                     "700-acre, 4.4M sq ft campus near Villa Rica, following "
                     "unanimous planning commission recommendations to deny. "
                     "It was the second denial on the same property in seven "
                     "months — sustained opposition can beat a second "
                     "application, not just a first.",
             "sources": ["https://www.fox5atlanta.com/news/douglas-county-leaders-just-killed-massive-data-center-project",
                         "https://www.douglascountysentinel.com/douglasville_sentinel/county-rejects-plans-for-700-acre-data-center-campus/article_a5761e68-bcdb-5537-a954-b2a948460ea3.html"]},
            {"as_of": "2026-08-23", "where": "Bastrop County, TX", "year": "2024",
             "what": "Bastrop County executed a tax abatement agreement with "
                     "EdgeConneX for buildings 1-4, dated 9 Dec 2024 and "
                     "posted in full on the county's own site. It is a "
                     "scanned document, so read the terms off the agreement "
                     "itself rather than from any summary — including this "
                     "one. Linked here because a signed abatement on a county "
                     "website is the paper trail your own county should be "
                     "asked to produce.",
             "sources": ["https://www.bastropcounty.gov/upload/page/0107/docs/Edge%20ConnecX%20inc.-%20Tax%20Abatement%20Agreement-%20Blg.%201-4%20with%20Exhibits%2012%209%2024.pdf"]},
        ],
    },
    "Core Scientific": {
        "pattern": (
        ...
        "concessions": [
            {"as_of": "2026-08-23", "where": "Marble, NC", "year": "2023-2026",
             "what": "Cherokee County's October 2023 moratorium on "
                     "high-impact industry covered crypto mines but not AI "
                     "processing. It expired, and the Marble mine was "
                     "converted to generative AI and is undergoing a "
                     "multimillion-dollar expansion; a January commissioners' "
                     "meeting to renew the pause and extend it to AI ended "
                     "with no action. The most quotable failure mode on this "
                     "page: a moratorium scoped to yesterday's technology "
                     "expires into the next one.",
             "sources": ["https://www.wunc.org/2026-04-10/cherokee-county-residents-were-upset-about-crypto-mines-then-came-ai",
                         "https://grist.org/politics/first-crypto-now-data-centers-how-tech-is-reshaping-this-north-carolina-community/"]},
            {"as_of": "2026-08-23", "where": "Dalton, GA", "year": "2025",
             "what": "Whitfield County commissioners voted 3-2 in March 2025 "
                     "— the chairman breaking a tie — to rezone 173.3 acres "
                     "on Old Tilton Road from agriculture and rural "
                     "residential to heavy manufacturing, with a 30-foot "
                     "vegetative buffer to screen and damp the site. A buffer "
                     "is what a tie vote buys; it is not a noise limit.",
             "sources": ["https://daltoncitizen.com/2025/03/11/whitfield-county-commissioners-approve-rezoning-for-data-center-despite-opposition/"]},
        ],
    },
}
...
SOURCES = {
    ...
    "tx_sb6_2025":    ("Texas Legislature (Senate Research Center) — SB 6, 89th Legislature: large-load / data-center interconnection standards (signed June 20, 2025)",
                      "https://capitol.texas.gov/BillLookup/History.aspx?LegSess=89R&Bill=SB6"),
...
EXECUTIVES = [
    ...
    {"company": "Google",       "name": "Ruth Porat",         "title": "President & Chief Investment Officer, Alphabet",
     "category": "leadership", "focus": "Capital allocation and infrastructure investment.",
     "linkedin": _li("Ruth Porat", "Alphabet")},
    # Joe Kava retired 2025, now adviser/board. Removed Aug 2026.
    ...
    {"company": "Google",       "name": "Ben Townsend",       "title": "Head of Infrastructure Strategy & Sustainability",
    ...
    # Urvi Parekh departed Meta ~Mar 2026. Removed Aug 2026.
    # Blair Anderson unverifiable at Meta — possible data mix-up. Removed Aug 2026.
    {"company": "Meta",         "name": "Santosh Janardhan",  "title": "Head of Infrastructure",
     "category": "infrastructure", "focus": "Global data center infrastructure strategy and operations.",
     "linkedin": _li("Santosh Janardhan", "Meta")},
    # --- Microsoft ---
    ...
    # Kevin Miller left AWS mid-2025. Replaced by Prasad Kalyanaraman.
    {"company": "Amazon (AWS)", "name": "Prasad Kalyanaraman", "title": "SVP, AWS Infrastructure",
     "category": "infrastructure", "focus": "AWS infrastructure including global data centers (S-team member since 2026).",
     "linkedin": _li("Prasad Kalyanaraman", "AWS")},
    {"company": "Amazon (AWS)", "name": "Chris Roe",          "title": "Head of Energy & Sustainable Operations",
    ...
    # Eric Schwartz stepped down after CyrusOne take-private sale. Replaced Jul 2026.
    {"company": "CyrusOne",     "name": "John Hatem",        "title": "President & CEO",
     "category": "leadership", "focus": "CyrusOne strategy under KKR/BlackRock ownership.",
     "linkedin": _li("John Hatem", "CyrusOne")},
...
EXEC_VERIFIED = {
    ...
    ("Meta", "Santosh Janardhan"):         "https://about.meta.com/media-gallery/executives/",
    ...
    ("Amazon (AWS)", "Prasad Kalyanaraman"): "https://www.aboutamazon.com/news/workplace/amazon-s-team-members",
    ...
    ("CyrusOne", "John Hatem"):            "https://cyrusone.com/leadership/",
...
LOCAL_BODIES = [
    ...
    {"locality": "Nye County", "state": "NV",
     "body": "Board of County Commissioners",
     "decides": "Zoning and land use for all unincorporated Nye County including "
                "Pahrump — the body considering Bill 2026-11 (data center ban in "
                "towns lacking an elected town board).",
     "meets": "1st and 3rd Tuesday 10:00 a.m., alternating between Tonopah and "
              "Pahrump chambers",
     "where": "2100 E. Walt Williams Dr., Pahrump, NV 89048 (Pahrump sessions)",
     "agenda_url": "https://www.nyecountynv.gov/AgendaCenter",
     "comment_process": "Three-minute limit per speaker. Remote callers give "
                        "first/last name, press *5 to queue. Comment on non-agenda "
                        "items must be within BOCC jurisdiction.",
     "phone": "", "email": "",
     "website": "https://www.nyecountynv.gov/552/Board-of-County-Commissioners",
     "as_of": "2026-08-18",
     "source": "https://www.nyecountynv.gov/552/Board-of-County-Commissioners"},

    {"locality": "Bastrop County", "state": "TX",
     "body": "Commissioners Court",
     "decides": "County budget, tax abatements and resolutions — including the "
                "hearing on the BCG Cedar Creek data center campus.",
     "meets": "Biweekly Mondays 9:00 a.m. (shifts to Tuesday after Monday holidays)",
     "where": "Commissioners Courtroom, 2nd Floor, 804 Pecan Street, Bastrop, TX 78602",
     "agenda_url": "https://www.bastropcounty.gov/page/co.county_clerk_Courtagendas",
     "comment_process": "Public Participation Form must be filed with the County "
                        "Clerk by 3:00 p.m. the Thursday before the meeting.",
     "phone": "", "email": "",
     "website": "https://www.bastropcounty.gov/page/com.information",
     "as_of": "2026-08-18",
     "source": "https://www.bastropcounty.gov/page/com.main"},

    {"locality": "Platte County", "state": "WY",
     "body": "Board of County Commissioners",
     "decides": "Final authority on rezonings — the body deciding the Site Layer 4 "
                "data center campus after the P&Z Commission recommends.",
     "meets": "1st and 3rd Tuesday 9:00 a.m., Courthouse basement",
     "where": "Courthouse, Wheatland, WY",
     "agenda_url": "https://www.plattecountywyoming.com/departments/planningandzoning/sitelayer4rezone",
     "comment_process": "Written comments to planner@plattecountywyoming.com. "
                        "Attend P&Z or Commissioners hearing in person.",
     "phone": "", "email": "planner@plattecountywyoming.com",
     "website": "https://www.plattecountywyoming.com/departments/Commissioners",
     "as_of": "2026-08-18",
     "source": "https://www.plattecountywyoming.com/departments/Commissioners"},

    {"locality": "Hanover Township", "state": "PA",
     "body": "Board of Supervisors",
     "decides": "Conditional use permits — hearing the Prime Data Centers / "
                "Starpointe Business Park application (jurisdiction in dispute "
                "with the Zoning Hearing Board).",
     "meets": "See township calendar for regular and special meetings",
     "where": "Hanover Volunteer Fire Department Hall, 9 Starck Drive (overflow "
              "venue for the data center hearing)",
     "agenda_url": "https://www.hanovertwp.org/",
     "comment_process": "Residents may petition for 'party status' to gain formal "
                        "standing in conditional-use hearings.",
     "phone": "", "email": "",
     "website": "https://www.hanovertwp.org/contacts",
     "as_of": "2026-08-18",
     "source": "https://www.hanovertwp.org/contacts"},

    {"locality": "Montgomery County", "state": "MD",
     "body": "County Council",
     "decides": "Legislation, budget, and land-use policy for 11 districts — "
                "passed a unanimous 18-month data center moratorium Jul 2026. "
                "The OZAH hearing examiner handles the Atmosphere Dickerson "
                "conditional use case (CU 24-13).",
     "meets": "Tuesdays 9:00 a.m. (full council); committees Mondays/Thursdays",
     "where": "Council Office Building, 100 Maryland Ave., Rockville, MD 20850",
     "agenda_url": "https://www.montgomerycountymd.gov/council/calendar.html",
     "comment_process": "Sign up for live testimony (Zoom or in-person) or submit "
                        "written/audio/video testimony via the council's testify page.",
     "phone": "240-777-7900", "email": "",
     "website": "https://www.montgomerycountymd.gov/government/legislative-branch/county-council/councilmembers",
     "as_of": "2026-08-18",
     "source": "https://www.montgomerycountymd.gov/government/legislative-branch/county-council/councilmembers"},

    {"locality": "Upper Merion Township", "state": "PA",
     "body": "Board of Supervisors",
     "decides": "Land use and rezoning — denied all five MLP Ventures data center "
                "proposals Aug 13, 2026. Developer filed suit and plans to appeal.",
     "meets": "Thursdays 7:00 p.m. at Freedom Hall; workshops 7:30 p.m. in "
              "the Board Room",
     "where": "175 W. Valley Forge Rd, King of Prussia, PA 19406",
     "agenda_url": "https://www.umtownship.org/AgendaCenter",
     "comment_process": "See township office (610-265-2600) for public comment "
                        "procedures.",
     "phone": "610-265-2600", "email": "",
     "website": "https://www.umtownship.org/308/Board-of-Supervisors",
     "as_of": "2026-08-18",
     "source": "https://www.umtownship.org/308/Board-of-Supervisors"},

    {"locality": "Monroe Township", "state": "NJ",
     "body": "Township Council",
     "decides": "Ordinances and resolutions — passed a township-wide data center "
                "ban Apr 2026, now in federal litigation with Hexa Builders "
                "($300M+ suit). Seven members plus an elected mayor.",
     "meets": "Wednesdays 7:00 p.m., some preceded by Ordinance Committee 6:30 p.m.",
     "where": "Municipal Building, 125 Virginia Avenue, Williamstown, NJ 08094",
     "agenda_url": "https://monroetownshipnj.org/township-council/regular-council-meeting-agendas/",
     "comment_process": "Public comment limited to 5 minutes per speaker per "
                        "Chapter 3 Section 17 of the Township Code.",
     "phone": "856-728-9800", "email": "",
     "website": "https://monroetownshipnj.org/township-council/6council-members/",
     "as_of": "2026-08-18",
     "source": "https://monroetownshipnj.org/township-council/6council-members/"},

    {"locality": "Colorado Springs", "state": "CO",
     "body": "City Council",
     "decides": "Ordinances, land use and appeals — hearing the Project Taurus / "
                "Raeden data center appeal Sep 17, 2026. Nine members (6 district "
                "+ 3 at-large).",
     "meets": "See council calendar; Sep 17 special hearing at 9:00 a.m. at "
              "Pikes Peak Center for the Performing Arts",
     "where": "City Hall (regular); Pikes Peak Center, 190 S. Cascade Ave. "
              "(Sep 17 special hearing)",
     "agenda_url": "https://coloradosprings.legistar.com/Calendar.aspx",
     "comment_process": "Sep 17 hearing: 120 speakers max, 2 min each. Sign up "
                        "by email to allcouncil@coloradosprings.gov with name, "
                        "address, and support/oppose position.",
     "phone": "719-385-5480", "email": "allcouncil@coloradosprings.gov",
     "website": "https://coloradosprings.gov/get-know-your-councilmembers",
     "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},

    {"locality": "Lyon Township", "state": "MI",
     "body": "Board of Trustees / Planning Commission",
     "decides": "Zoning and site plan review — the Planning Commission conditionally "
                "approved Compass Datacenters' 'Project Flex' site plan in Sep 2025. "
                "Seven-member Board of Trustees is the final authority.",
     "meets": "Board of Trustees: varies; Planning Commission: 2nd Monday, 6:00 p.m.",
     "where": "Lyon Township Hall, 58000 Grand River Ave, New Hudson, MI 48165",
     "agenda_url": "https://lyontownshipmi.documents-on-demand.com/",
     "comment_process": "Public comment at regular meetings; contact Township Clerk "
                        "for sign-up procedures.",
     "phone": "", "email": "",
     "website": "https://www.lyontwp.org/government/township_boards_and_commissions/board_of_trustees.php",
     "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/board_of_trustees.php"},

    {"locality": "Pataskala", "state": "OH",
     "body": "City Council",
     "decides": "Zoning and land use (7 members: 3 at-large, 4 by ward). Aligned "
                "Data Centers proposed a campus on the city's eastern boundary.",
     "meets": "1st and 3rd Monday of the month",
     "where": "Pataskala City Hall",
     "agenda_url": "https://www.cityofpataskalaohio.gov/cocagendasandminutes",
     "comment_process": "Citizens' Comments period on regular meeting agendas.",
     "phone": "", "email": "",
...
LOCAL_OFFICIALS = [
    ...
    # ── Nye County, NV (Pahrump / Manse Technology Campus) ──
    {"locality": "Nye County", "state": "NV", "body": "Board of County Commissioners",
     "name": "Ron Boskovich", "role": "Chair", "district": "District 4",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.nyecountynv.gov/552/Board-of-County-Commissioners"},
    {"locality": "Nye County", "state": "NV", "body": "Board of County Commissioners",
     "name": "John Koenig", "role": "Vice-Chair", "district": "District 2",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.nyecountynv.gov/552/Board-of-County-Commissioners"},
    {"locality": "Nye County", "state": "NV", "body": "Board of County Commissioners",
     "name": "Bruce Jabbour", "role": "Commissioner", "district": "District 1",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.nyecountynv.gov/552/Board-of-County-Commissioners"},
    {"locality": "Nye County", "state": "NV", "body": "Board of County Commissioners",
     "name": "Ian Bayne", "role": "Commissioner", "district": "District 3",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.nyecountynv.gov/552/Board-of-County-Commissioners"},
    {"locality": "Nye County", "state": "NV", "body": "Board of County Commissioners",
     "name": "Debra Strickland", "role": "Commissioner", "district": "District 5",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.nyecountynv.gov/552/Board-of-County-Commissioners"},

    # ── Bastrop County, TX (BCG Cedar Creek Campus) ──
    {"locality": "Bastrop County", "state": "TX", "body": "Commissioners Court",
     "name": "Gregory Klaus", "role": "County Judge", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.bastropcounty.gov/page/co.county_judge"},
    {"locality": "Bastrop County", "state": "TX", "body": "Commissioners Court",
     "name": "Butch Carmack", "role": "Commissioner", "district": "Precinct 1",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.bastropcounty.gov/page/com.pct_1"},
    {"locality": "Bastrop County", "state": "TX", "body": "Commissioners Court",
     "name": "Clara Beckett", "role": "Commissioner", "district": "Precinct 2",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.bastropcounty.gov/page/com.pct_2"},
    {"locality": "Bastrop County", "state": "TX", "body": "Commissioners Court",
     "name": "Mark Meuth", "role": "Commissioner", "district": "Precinct 3",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.bastropcounty.gov/page/com.pct_3"},
    {"locality": "Bastrop County", "state": "TX", "body": "Commissioners Court",
     "name": "David Glass", "role": "Commissioner", "district": "Precinct 4",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.bastropcounty.gov/page/com.pct_4"},

    # ── Platte County, WY (Site Layer 4) ──
    {"locality": "Platte County", "state": "WY", "body": "Board of County Commissioners",
     "name": "Steve Shockley", "role": "Chairman", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.plattecountywyoming.com/departments/Commissioners"},
    {"locality": "Platte County", "state": "WY", "body": "Board of County Commissioners",
     "name": "Ian Jolovich", "role": "Commissioner", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.plattecountywyoming.com/departments/Commissioners"},
    {"locality": "Platte County", "state": "WY", "body": "Board of County Commissioners",
     "name": "John \"Jeb\" Baker", "role": "Commissioner", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.plattecountywyoming.com/departments/Commissioners"},

    # ── Hanover Township, PA (Prime Data Centers / Starpointe) ──
    {"locality": "Hanover Township", "state": "PA", "body": "Board of Supervisors",
     "name": "Dale Handick", "role": "Chairman", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.hanovertwp.org/contacts"},
    {"locality": "Hanover Township", "state": "PA", "body": "Board of Supervisors",
     "name": "William Michael", "role": "Vice Chair", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.hanovertwp.org/contacts"},
    {"locality": "Hanover Township", "state": "PA", "body": "Board of Supervisors",
     "name": "Shawn Miller", "role": "Supervisor", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.hanovertwp.org/contacts"},

    # ── Upper Merion Township, PA (King of Prussia / MLP Ventures) ──
    {"locality": "Upper Merion Township", "state": "PA", "body": "Board of Supervisors",
     "name": "Tina Garzillo", "role": "Chairperson", "district": "",
     "email": "", "phone": "610-265-2600", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.umtownship.org/308/Board-of-Supervisors"},
    {"locality": "Upper Merion Township", "state": "PA", "body": "Board of Supervisors",
     "name": "William Jenaway", "role": "Vice Chairperson", "district": "",
     "email": "", "phone": "610-265-2600", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.umtownship.org/308/Board-of-Supervisors"},
    {"locality": "Upper Merion Township", "state": "PA", "body": "Board of Supervisors",
     "name": "Greg Philips", "role": "Supervisor", "district": "",
     "email": "", "phone": "610-265-2600", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.umtownship.org/308/Board-of-Supervisors"},
    {"locality": "Upper Merion Township", "state": "PA", "body": "Board of Supervisors",
     "name": "Carole Kenney", "role": "Supervisor", "district": "",
     "email": "", "phone": "610-265-2600", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.umtownship.org/308/Board-of-Supervisors"},
    {"locality": "Upper Merion Township", "state": "PA", "body": "Board of Supervisors",
     "name": "Greg Waks", "role": "Supervisor", "district": "",
     "email": "", "phone": "610-265-2600", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.umtownship.org/308/Board-of-Supervisors"},

    # ── Monroe Township, NJ (data center ban / Hexa litigation) ──
    {"locality": "Monroe Township", "state": "NJ", "body": "Township Council",
     "name": "Gregory A. Wolfe", "role": "Mayor", "district": "",
     "email": "", "phone": "856-728-9800", "stance": "", "as_of": "2026-08-18",
     "source": "https://monroetownshipnj.org/mayor/"},
    {"locality": "Monroe Township", "state": "NJ", "body": "Township Council",
     "name": "Donald Heverly", "role": "Council President", "district": "",
     "email": "", "phone": "856-728-9800", "stance": "", "as_of": "2026-08-18",
     "source": "https://monroetownshipnj.org/township-council/6council-members/"},
    {"locality": "Monroe Township", "state": "NJ", "body": "Township Council",
     "name": "Denise Adams", "role": "Vice President", "district": "",
     "email": "", "phone": "856-728-9800", "stance": "", "as_of": "2026-08-18",
     "source": "https://monroetownshipnj.org/township-council/6council-members/"},
    {"locality": "Monroe Township", "state": "NJ", "body": "Township Council",
     "name": "Brian Cope", "role": "Council Member", "district": "",
     "email": "", "phone": "856-728-9800", "stance": "", "as_of": "2026-08-18",
     "source": "https://monroetownshipnj.org/township-council/6council-members/"},
    {"locality": "Monroe Township", "state": "NJ", "body": "Township Council",
     "name": "John Valentine", "role": "Council Member", "district": "",
     "email": "", "phone": "856-728-9800", "stance": "", "as_of": "2026-08-18",
     "source": "https://monroetownshipnj.org/township-council/6council-members/"},
    {"locality": "Monroe Township", "state": "NJ", "body": "Township Council",
     "name": "Albert Rossi", "role": "Council Member", "district": "",
     "email": "", "phone": "856-728-9800", "stance": "", "as_of": "2026-08-18",
     "source": "https://monroetownshipnj.org/township-council/6council-members/"},
    {"locality": "Monroe Township", "state": "NJ", "body": "Township Council",
     "name": "Patrick O'Reilly", "role": "Council Member", "district": "",
     "email": "", "phone": "856-728-9800", "stance": "", "as_of": "2026-08-18",
     "source": "https://monroetownshipnj.org/township-council/6council-members/"},
    {"locality": "Monroe Township", "state": "NJ", "body": "Township Council",
     "name": "Carolann Fox", "role": "Council Member", "district": "",
     "email": "", "phone": "856-728-9800", "stance": "", "as_of": "2026-08-18",
     "source": "https://monroetownshipnj.org/township-council/6council-members/"},

    # ── Colorado Springs, CO (Project Taurus / Raeden) ──
    {"locality": "Colorado Springs", "state": "CO", "body": "City Council",
     "name": "Lynette Crow-Iverson", "role": "Council President", "district": "At-Large",
     "email": "allcouncil@coloradosprings.gov", "phone": "719-385-5480", "stance": "", "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},
    {"locality": "Colorado Springs", "state": "CO", "body": "City Council",
     "name": "Brian Risley", "role": "President Pro Tem", "district": "At-Large",
     "email": "allcouncil@coloradosprings.gov", "phone": "719-385-5480", "stance": "", "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},
    {"locality": "Colorado Springs", "state": "CO", "body": "City Council",
     "name": "David Leinweber", "role": "Council Member", "district": "At-Large",
     "email": "allcouncil@coloradosprings.gov", "phone": "719-385-5480", "stance": "", "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},
    {"locality": "Colorado Springs", "state": "CO", "body": "City Council",
     "name": "Dave Donelson", "role": "Council Member", "district": "District 1",
     "email": "allcouncil@coloradosprings.gov", "phone": "719-385-5480", "stance": "", "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},
    {"locality": "Colorado Springs", "state": "CO", "body": "City Council",
     "name": "Ken Casey", "role": "Council Member", "district": "District 2",
     "email": "allcouncil@coloradosprings.gov", "phone": "719-385-5480", "stance": "", "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},
    {"locality": "Colorado Springs", "state": "CO", "body": "City Council",
     "name": "Brandy Williams", "role": "Council Member", "district": "District 3",
     "email": "allcouncil@coloradosprings.gov", "phone": "719-385-5480", "stance": "", "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},
    {"locality": "Colorado Springs", "state": "CO", "body": "City Council",
     "name": "Kimberly Gold", "role": "Council Member", "district": "District 4",
     "email": "allcouncil@coloradosprings.gov", "phone": "719-385-5480", "stance": "", "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},
    {"locality": "Colorado Springs", "state": "CO", "body": "City Council",
     "name": "Nancy Henjum", "role": "Council Member", "district": "District 5",
     "email": "allcouncil@coloradosprings.gov", "phone": "719-385-5480", "stance": "", "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},
    {"locality": "Colorado Springs", "state": "CO", "body": "City Council",
     "name": "Roland Rainey", "role": "Council Member", "district": "District 6",
     "email": "allcouncil@coloradosprings.gov", "phone": "719-385-5480", "stance": "", "as_of": "2026-08-18",
     "source": "https://coloradosprings.gov/get-know-your-councilmembers"},

    # ── Lyon Township, MI (Project Flex / Compass Datacenters) ──
    {"locality": "Lyon Township", "state": "MI", "body": "Board of Trustees",
     "name": "John Dolan", "role": "Supervisor", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/board_of_trustees.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Board of Trustees",
     "name": "Michele Cash", "role": "Clerk", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/board_of_trustees.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Board of Trustees",
     "name": "Patricia Carcone", "role": "Treasurer", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/board_of_trustees.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Board of Trustees",
     "name": "Lise Blades", "role": "Trustee", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/board_of_trustees.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Board of Trustees",
     "name": "Kristofer Enlow", "role": "Trustee", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/board_of_trustees.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Board of Trustees",
     "name": "Sean O'Neil", "role": "Trustee", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/board_of_trustees.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Board of Trustees",
     "name": "Robert Swain", "role": "Trustee", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/board_of_trustees.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Planning Commission",
     "name": "Mike Conflitti", "role": "Chairperson", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/planning_commissioners___past_and_present.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Planning Commission",
     "name": "Carl Towne", "role": "Vice-Chairperson", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/planning_commissioners___past_and_present.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Planning Commission",
     "name": "Jim Chuck", "role": "Secretary", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/planning_commissioners___past_and_present.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Planning Commission",
     "name": "Kurt Radke", "role": "Member", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/planning_commissioners___past_and_present.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Planning Commission",
     "name": "Ron Pennington", "role": "Member", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/planning_commissioners___past_and_present.php"},
    {"locality": "Lyon Township", "state": "MI", "body": "Planning Commission",
     "name": "Branko Mitkovski", "role": "Member", "district": "",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.lyontwp.org/government/township_boards_and_commissions/planning_commissioners___past_and_present.php"},

    # ── Pataskala, OH (Aligned Data Centers) ──
    {"locality": "Pataskala", "state": "OH", "body": "City Council",
     "name": "Kip Rooks", "role": "Council Member", "district": "At-Large",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.cityofpataskalaohio.gov/citycouncil"},
    {"locality": "Pataskala", "state": "OH", "body": "City Council",
     "name": "Chad Wagy", "role": "Council Member", "district": "At-Large",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.cityofpataskalaohio.gov/citycouncil"},
    {"locality": "Pataskala", "state": "OH", "body": "City Council",
     "name": "Tim Hickin", "role": "Council Member", "district": "At-Large",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.cityofpataskalaohio.gov/citycouncil"},
    {"locality": "Pataskala", "state": "OH", "body": "City Council",
     "name": "Jude Hampshire", "role": "Council Member", "district": "Ward 1",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.cityofpataskalaohio.gov/citycouncil"},
    {"locality": "Pataskala", "state": "OH", "body": "City Council",
     "name": "Mary Hite", "role": "Council Member", "district": "Ward 2",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.cityofpataskalaohio.gov/citycouncil"},
    {"locality": "Pataskala", "state": "OH", "body": "City Council",
     "name": "Deborah Kohman", "role": "Council Member", "district": "Ward 3",
     "email": "", "phone": "", "stance": "", "as_of": "2026-08-18",
     "source": "https://www.cityofpataskalaohio.gov/citycouncil"},
    {"locality": "Pataskala", "state": "OH", "body": "City Council",
