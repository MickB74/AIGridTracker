...
def build_comment_scripts(state, mw, imp, upgrade_per_home_yr,
    ...
    if lang == "es":
        main = (
            ...
            f"reales: The Dalles obtuvo de Google unos $28.5 millones para "
            f"su sistema de agua; Groton hizo de un límite de 12,500 pies "
            f"cuadrados por edificio una condición de zonificación.\n\n"
        ...
        topics = [
            ...
            ("Agua",
             ...
             f"requiera nueva aprobación. En The Dalles, Google pagó unos "
             f"$28.5 millones en infraestructura de agua — nosotros no "
    ...
    main = (
        ...
        f"about $28.5 million in water-system funding from Google; Groton, "
        f"CT capped data-center buildings at 12,500 sq ft as a zoning "
        f"condition after a one-year moratorium.\n\n"
    ...
    topics = [
        ...
        ("Water",
         ...
         f"before any expansion. The Dalles got about $28.5 million of "
         f"water infrastructure from Google — we should not accept less "
         f"transparency."),
        ("Accountability",
...
def build_social_posts(state, mw, imp, upgrade_per_home_yr,
    ...
    facebook = (
        ...
        f"grid upgrades\n\n"
        f"Communities that organized won real protections — The Dalles got "
        f"about $28.5M in water-system funding from Google; Groton capped "
        f"data-center buildings at 12,500 sq ft as a zoning condition. We "
        f"can too, but only BEFORE approval.\n\n"
...
def build_letters(state, operator, mw, puc_name, puc_complaint):
    ...
    council = {
        ...
        "body": (
            ...
            f"Precedents: The Dalles, OR secured about $28.5M in water "
            f"infrastructure from Google; Groton, CT capped data-center "
            f"buildings at 12,500 sq ft as a zoning condition. Communities "
            f"that asked, received; communities that didn't, paid.\n\n"
